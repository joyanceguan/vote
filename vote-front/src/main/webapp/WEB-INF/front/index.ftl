...
<body id="body">
  ...
  <div id="preloader">
	  ...
	  End Preloader
	  ==================================== -->
	<header class="navigation navbar navbar-fixed-top sticky-header">
		<div class="container">
	  ...
	  <section  class="counter parallax-section" style="padding-bottom: 0px;">
			<div class="container">
				<div class="row">
					
					<!-- first count item -->
					<div class="col-md-5 col-sm-6 col-xs-2 text-center " id ="hotlist" style="width: 20%">
						<div class="counters-item" style="font-size: 1px;padding-bottom:10px;">
							<i class="tf-ios-alarm-outline"></i>
							<h3>热投</h3>
						</div>
					</div>
					<div class="col-md-5 col-sm-6 col-xs-2 text-center " id="ranklist" style="width: 20%">
							<div class="counters-item" style="font-size: 1px;padding-bottom:10px;">
								<i class="tf-ios-alarm-outline"></i>
								<h3>榜单投</h3>
							</div>
	  ...
	  <section class="team-skills parallax-section" id="skillss" style="padding-bottom: 0;padding-top: 0px;">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
		...
		<section class="portfolio" id="portfolio" style="padding-top: 0px;padding-bottom: 0px;">
	...
	<!-- Start Team Skills
			=========================================== -->
			<section class="team-skills parallax-section" id="skills"  style="padding-top: 0;padding-bottom: 10px;">
				<div class="container" id="portfolio-items-wrapper" index-id="items">
					<div class="row">
						<div class="col-md-5">
							<div class="team-skills-content">
								<h4 style="font-weight: 800;">言承旭公开认爱111</h4>
								<p>言承旭公开认爱,林志玲尴尬回应,16年的感情终于结束了? 言承旭大家应该都不陌生吧,看到他还是会想起01年《流星花园》里面的“道明寺”,当时帅气阳光的他,可是圈了一.<br></p>
							</div>
						</div>
